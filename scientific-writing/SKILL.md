...
description: "This is the core skill for the deep research and writing tool\u2014\
  combining AI-driven deep research with well-formatted written outputs. Every document\
  \ produced is backed by comprehensive literature search and verified citations through\
  \ the research-lookup skill."
license: MIT license
metadata:
