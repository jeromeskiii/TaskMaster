...
description: Web fuzzing with ffuf — fast web fuzzer for discovering hidden directories, files, parameters, and virtual hosts with configurable wordlists and filtering
risk: safe
